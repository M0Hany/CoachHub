import 'package:coachhub/core/theme/app_colors.dart';
...
class CoachChatsScreen extends StatelessWidget {
  const CoachChatsScreen({super.key});
  ...
  Widget build(BuildContext context) {
    ...
    final chats = [
      {
        'name': 'Walid Adel',
        'lastMessage': 'Hey Mourad, how\'s your workout\nand nutrition plan going?',
        'time': 'Just Now',
      ...
      {
        'name': 'James Lee',
        'lastMessage': 'New workout plan is ready for review',
        'time': '5h ago',
        'imageUrl': 'assets/images/default_profile.jpg',
        'unread': false,
        'unreadCount': 0,
      ...
      {
        'name': 'Sofia Patel',
        'lastMessage': 'Great job completing today\'s exercises!',
        'time': '6h ago',
        'imageUrl': 'assets/images/default_profile.jpg',
        'unread': true,
        'unreadCount': 4,
                      ...
                      itemBuilder: (context, index) {
                        ...
                        return Padding(
                          ...
                          child: ChatPreviewBubble(
                            ...
                            onTap: () => context.push('/coach/chats/${chat['name']}'),
                          ),
                        );
                      },
                    ),
