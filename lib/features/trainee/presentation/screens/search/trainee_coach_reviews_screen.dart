...
class TraineeCoachReviewsScreen extends StatefulWidget {
  final String coachId;
  final String? coachImageUrl;
  final String? coachFullName;
  const TraineeCoachReviewsScreen({
    super.key,
  ...
  @override
  State<TraineeCoachReviewsScreen> createState() => _TraineeCoachReviewsScreenState();
}

class _TraineeCoachReviewsScreenState extends State<TraineeCoachReviewsScreen> {
  ...
  Future<void> _fetchReviews() async {
    try {
      ...
      final response = await httpClient.get('/api/review/${widget.coachId}');
