...
class NutritionPlanDetailsScreen extends StatefulWidget {
  const NutritionPlanDetailsScreen({super.key});

  @override
  State<NutritionPlanDetailsScreen> createState() => _NutritionPlanDetailsScreenState();
}

class _NutritionPlanDetailsScreenState extends State<NutritionPlanDetailsScreen> {
                                                    ...
                                                    children: [
                                                      GestureDetector(
                                                        onTap: () {
                                                          ...
                                                          context.push('/trainee/meal-details');
                                                        },
                                                        child: SizedBox(
                                                          height: cellHeight,
                                                          child: Row(
